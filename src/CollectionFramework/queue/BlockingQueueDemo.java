...
class BockingQueueDemo {
    public static void main(String[] args) {
        BlockingQueue<Integer> queue = new ArrayBlockingQueue<>(5);
        // thread-safe CollectionFramework.queue
        // wait for CollectionFramework.queue to become non-empty / wait for space
        // simplify concurrency problems like producer-consumer
        // standard CollectionFramework.queue --> immediately
        // empty --> remove ( no waiting )
        // full --> add ( no waiting )
        // Blocking CollectionFramework.queue
        // put -->  Blocks if the CollectionFramework.queue is full until space becomes available
        // take --> Blocks if the CollectionFramework.queue is empty until an element becomes available
        // offer --> Waits for space to become available, up to the specified timeout

        // A bounded, blocking CollectionFramework.queue backed by circular array
        // low memory overhead
...
//        consumer.start();
        ...
        BlockingQueue<String> queue2 = new PriorityBlockingQueue<>(11, Comparator.comparing(String::length));
        // unbounded
        // Binary Heap as array and can grow dynamically
        // Head is based on their natural ordering or a provided Comparator like priority CollectionFramework.queue
        // put won't block
        queue2.add("apple");
        queue2.add("banana");
        queue2.add("cherry");
